<script>
    ...
    import IconSnippet from "~icons/tabler/cut"
...
<nav class="p-4 flex items-center justify-between border-b-2 border-secondary-light/80 dark:border-secondary-dark/20 fixed top-0 w-full z-50 bg-primary-light dark:bg-primary-dark">
    <div class="flex items-center gap-10">
        ...
        <div class="lg:flex hidden items-center gap-5">
            ...
            <a href="/snippet" class="text-secondary-light dark:text-secondary-dark dark:hover:text-primary-dark hover:text-primary-light transition-all">Snippets</a>
            ...
            <a href="rss.xml" class="text-secondary-light dark:text-secondary-dark dark:hover:text-primary-dark hover:text-primary-light transition-all">RSS</a>
        </div>
    </div>
...
>
    ...
    <button type="button" on:click={() => goToUrl("/snippet")} class="flex justify-between w-full gap-5 items-center p-2 rounded group">
        <p class="text-xl group-hover:text-accent transition-all">Snippets</p>
        <IconSnippet class="w-6 h-6" />
    </button>
    ...
    <button type="button" on:click={() => goToUrl("/blog")} class="flex justify-between w-full gap-5 items-center p-2 rounded group">
        <p class="text-xl group-hover:text-accent transition-all">RSS</p>
